...
export default function MobileNav() {
    ...
    !toggleSearch ? (
      ...
      <div className="relative flex w-full p-6">
        <div
          ...
          className="absolute right-7 top-7 p-[7px] rounded-full hover:bg-gray-200"
        >
          <IconSearch size={25} />
        </div>
        <input
  ...
  const handleLoginDisplay = () => {
    return status == "loading" ? (
      <div className="w-1/5 min-w-fit flex items-center justify-center gap-2 p-3 text-xs hover:bg-[#B2BAAB] hover:bg-opacity-80 transition-all">
      ...
      <Link
        href={"/login"}
        className="w-1/5 min-w-fit flex items-center justify-center gap-2 p-3 text-xs hover:bg-[#B2BAAB] hover:bg-opacity-80 transition-all"
      >
        <div className="flex flex-col items-center justify-center gap-2">
          <IconAvatar size={35} />
          <span>Login</span>
    ...
    <nav className="fixed bottom-0 left-0 flex flex-col items-center w-full md:hidden">
      <div className="w-full flex flex-col items-center relative bg-[#CFD4CB]">
        ...
        <div className="flex items-center w-full overflow-x-scroll">
          <Link
            href={"/"}
            className="w-1/5 min-w-fit flex flex-col items-center justify-center gap-2 p-3 text-xs hover:bg-[#B2BAAB] hover:bg-opacity-80 transition-all"
          >
            <IconHome size={35} />
            <span>Home</span>
          </Link>
          <div
            ...
            className="w-1/5 min-w-fit flex flex-col items-center justify-center gap-2 p-3 text-xs cursor-pointer hover:bg-[#B2BAAB] hover:bg-opacity-80 transition-all"
          >
            <IconSearch size={35} />
            <span>Search</span>
          </div>
